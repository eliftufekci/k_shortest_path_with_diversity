...
data = np.genfromtxt('/content/sample_data/USA-road-d.FLA.gr', usecols=(1,2,3))
np.savetxt('cleanedRoadFLA', data, fmt='%d')
G = nx.read_weighted_edgelist('cleanedRoadFLA', create_using=nx.DiGraph(), nodetype=int)
...
result = FindKSPD(G, GR, src=src, dest=dest, k=30, threshold=0.6)
