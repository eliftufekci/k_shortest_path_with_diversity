    ...
    public static void main(String[] args) {
        ...
        for (String[] entry : graphs) {
            ...
            for (int i = 0; i < kValues.length; i++) {
                System.out.println(String.format("  %-5d | %-18s | %14.4f | %12.2f",
                        kValues[i], "FindKSP(τ=1)", kspdResults.get(i).avgTime, kspdResults.get(i).avgNumPaths));
                System.out.println(String.format("  %-5d | %-18s | %14.4f | %12.2f",
                        kValues[i], "IterBound", iterResults.get(i).avgTime, iterResults.get(i).avgNumPaths));
                System.out.println("  " + "-".repeat(58));
            }
