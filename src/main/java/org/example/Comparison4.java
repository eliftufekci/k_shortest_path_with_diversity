...
import org.example.algorithms.FindKSPD_yen;
...
//                else if (algorithm instanceof FindKSPD_yen) pathCount = ((FindKSPD_yen) algorithm).getNumberOfPathsExplored();
    ...
    private static AlgorithmResult[] runGraphComparison(
        ...
        System.out.println("\n  ── Result for " + graphLabel + " (k=" + k + ", τ=" + threshold + ") ──");
        System.out.println(String.format("  %-18s | %-12s | %-10s", "Algorithm", "Avg Time(s)", "Avg Paths"));
        System.out.println("  " + "-".repeat(46));
        System.out.println(String.format("  %-18s | %12.4f | %10.2f", "FindKSPD",  resKSPD.avgTime,    resKSPD.avgNumPaths));
        System.out.println(String.format("  %-18s | %12.4f | %10.2f", "FindKSPD-", resKSPD_.avgTime,   resKSPD_.avgNumPaths));
        System.out.println(String.format("  %-18s | %12.4f | %10.2f", "KSPD-Yen",  resKSPDYen.avgTime, resKSPDYen.avgNumPaths));
       ...
       return new AlgorithmResult[]{resKSPD, resKSPD_, resKSPDYen};
...
//                totalYenT += r[2].avgTime; totalYenP += r[2].avgNumPaths;
                ...
                System.err.println("❌ OOM " + entry[0]); System.gc();
            }
        }
        ...
        if (ok > 0) {
            ...
            System.out.println(String.format("  %-18s | %14.4f | %12.2f", "FindKSPD",  totalKspdT/n,  totalKspdP/n));
            System.out.println(String.format("  %-18s | %14.4f | %12.2f", "FindKSPD-", totalKspd_T/n, totalKspd_P/n));
            System.out.println(String.format("  %-18s | %14.4f | %12.2f", "KSPD-Yen",  totalYenT/n,   totalYenP/n));
        }
    }
}
