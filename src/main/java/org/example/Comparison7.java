...
public class Comparison7 {
    ...
    public static void main(String[] args) {
        ...
        SimilarityMetric[] metrics = SimilarityMetric.values();
        int k = 10;
        ...
        for (String[] entry : graphs) {
            ...
            for (SimilarityMetric metric : metrics) {
                ...
                FindKSPD kspd = new FindKSPD(graph, threshold, metric);
                kspdResults.add(runAlgorithm(kspd, "FindKSPD(" + metric + ")", nodePairs, k));

                FindKSPD_ kspd_ = new FindKSPD_(graph, threshold, metric);
                kspd_Results.add(runAlgorithm(kspd_, "FindKSPD-(" + metric + ")", nodePairs, k));
